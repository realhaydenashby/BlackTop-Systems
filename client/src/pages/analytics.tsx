    ...
    <div className="p-6 space-y-6">
      ...
      {section === "forecasting" && (
        <>
          <ForecastCharts 
            demoData={{
              historicalData: analytics?.forecasting?.historicalData,
              currentMonth: analytics?.forecasting?.currentMonth,
              forecast30Days: analytics?.forecasting?.forecast30Days,
              forecast90Days: analytics?.forecasting?.forecast90Days,
              forecast6Months: analytics?.forecasting?.forecast6Months,
            }}
          />
